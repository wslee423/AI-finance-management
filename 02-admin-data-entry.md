...
| 사용자 | 버튼 그룹 | ✅ | 공동 | Owner / Spouse / Child / 공동 |
...
```
자산 유형  |  기관명              | 소유자 | 금액
부동산     | [아파트]            | 공동   | [__________]
부동산     | 전세(임차료)         | 공동   | [__________]
통장       | [증권사A](주식통장)    | Owner   | [__________]
통장       | [스톡옵션계좌]       | Owner   | [__________]
연금       | 퇴직금(DC)           | Owner   | [__________]
연금       | ISA(개인저축계좌)    | Owner   | [__________]
연금       | 연금저축             | Spouse   | [__________]
통장       | CMA MMW              | Owner   | [__________]
...
...
- **모바일 우선**: Owner·Spouse이 스마트폰으로도 입력 가능해야 함. 폼 필드 최소 44px 터치 영역.
